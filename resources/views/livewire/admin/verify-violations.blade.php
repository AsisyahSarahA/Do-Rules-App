            ...
            <div class="overflow-x-auto">
                ...
                <table class="w-full text-left">
                    ...
                    <tbody class="divide-y divide-gray-50">
                        ...
                        <tr wire:key="violation-{{ $v->id }}" class="group hover:bg-gray-50/50 transition-all">
                            ...
                            <td class="px-8 py-5">
                                ...
                                <span class="
                                            ...
                                            @if ($v->rule->level == 'ringan')
                                                bg-green-50 text-green-600
                                            @elseif($v->rule->level == 'sedang')
                            ...
                            <td class="px-8 py-5 text-center">
                                ...
                                <button wire:click="verify({{ $v->id }})" wire:confirm="Yakin ingin memverifikasi?"
