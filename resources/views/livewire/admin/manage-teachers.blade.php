                ...
                <form wire:submit.prevent="save" class="space-y-5">
                    ...
                    <div class="pt-2">
                        <button type="submit" 
                            ...
                            <span wire:loading.remove wire:target="save">{{ $isEdit ? 'Simpan Perubahan' : 'Daftarkan Akun' }}</span>
                            ...
                            <tr class="group hover:bg-gray-50/50 transition-all">
                                ...
                                <td class="px-8 py-5 text-center">
                                    <div class="flex justify-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity duration-200">
                                        ...
                                        <button wire:click="delete({{ $teacher->id }})" class="p-2 text-rose-400 hover:bg-rose-50 rounded-lg transition-all" title="Hapus User">
